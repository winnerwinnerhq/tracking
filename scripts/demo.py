...
def process_video_with_samurai(video_path, txt_path, model_path, video_output_path, start_frame, save_to_video=True):
    ...
    with open(ALL_OBJECTS_TXT, 'a') as tracks_output_file:
            ...
            for frame_idx, object_ids, masks in predictor.propagate_in_video(state):
                ...
                for obj_id, mask in zip(object_ids, masks):
                    ...
                    if obj_id == 0:
                        x, y, w, h = bbox
                        speed = 0.0
                        tracks_output_file.write(f"{start_frame + frame_idx},1,0,{x},{y},{w},{h},{speed:.2f}\n")
...
def main(args):
    ...
    process_video_with_samurai(
        video_path=TRIMMED_VIDEO_PATH,
        txt_path=TEMP_BBOX_TXT,
        model_path=args.samurai_model_path,
        video_output_path=args.video_output_path,
        start_frame=start_frame,
        save_to_video=args.save_to_video
    )
